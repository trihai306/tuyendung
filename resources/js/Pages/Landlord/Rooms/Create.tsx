...
export default function Create() {
    const { data, setData, post, processing, errors } = useForm({
        title: '',
        description: '',
        room_type: '' as 'single' | 'shared' | 'apartment' | 'mini_apartment' | '',
        price: '',
        area_sqm: '',
        address: '',
        district: '',
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('landlord.rooms.store'));
    };

    return (
        <AuthenticatedLayout title="Đăng phòng trọ" header="Đăng phòng trọ mới">
            <Head title="Đăng phòng trọ" />
