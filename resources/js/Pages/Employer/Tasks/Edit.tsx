...
import type { CompanyMember, RecruitmentTask } from '@/types';
...
export default function Edit({ task, members }: Props) {
    const form = useForm<{
        assigned_to: number[];
        title: string;
        type: string;
        ...
        title: task.title || '',
        type: task.type || 'chinh_thuc',
        description: task.description || '',
        priority: task.priority || 'medium',
        target_quantity: String(task.target_quantity || '1'),
        due_date: task.due_date ? task.due_date.split('T')[0] : '',
        work_dates: task.work_dates || [],
        work_shifts: task.work_shifts || [],
        overtime_hours: String(task.overtime_hours || '0'),
        shift_rate: task.shift_rate ? String(task.shift_rate) : '',
        overtime_rate: task.overtime_rate ? String(task.overtime_rate) : '',
    });
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        form.put(route('employer.tasks.update', task.id));
    };
    ...
    return (
        <AuthenticatedLayout title="Chinh sua nhiem vu" header="Chinh sua nhiem vu">
            <Head title="Chinh sua nhiem vu" />

            <PermissionGate permission="tasks.update_any">
                                    ...
                                    <CardContent className="pt-5 pb-5">
                                        <div className="flex items-center gap-2 mb-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[11px] text-muted-foreground">Chinh sua thong tin nhiem vu</p>
                                            </div>
                                        </div>
