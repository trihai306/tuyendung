...
export default function Edit({ jobPost, categories }: Props) {
    const { data, setData, patch, processing, errors } = useForm({
        title: jobPost.title || '',
        description: jobPost.description || '',
        job_type: jobPost.job_type || '',
        category_id: jobPost.category_id ? String(jobPost.category_id) : '',
        salary_min: jobPost.salary_min ? String(jobPost.salary_min) : '',
        salary_max: jobPost.salary_max ? String(jobPost.salary_max) : '',
        ...
        slots: jobPost.slots ? String(jobPost.slots) : '',
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        patch(route('employer.jobs.update', jobPost.id));
    };

    return (
        <AuthenticatedLayout title="Chỉnh sửa tin tuyển dụng" header="Chỉnh sửa tin tuyển dụng">
                    ...
                    <div className="space-y-6">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Cập nhật thong tin tin tuyen dung
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        placeholder="VD: Tuyen nhan vien ban hang"
                                    />
                                    {errors.title && (
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="description">Mô tả cong viec *</Label>
                                    <Textarea
                                        id="description"
                                        value={data.description}
                                        onChange={(e) => setData('description', e.target.value)}
                                        rows={6}
                                        placeholder="Mô tả chi tiet cong viec..."
                                    />
                                    {errors.description && (
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="grid gap-4 md:grid-cols-2">
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="experience_level">Kinh nghiệm yeu cau</Label>
                                        <Select
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                <SelectItem value="none">Khong yeu cau</SelectItem>
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                <div className="space-y-2">
                                    <Label htmlFor="location">Địa chỉ cu the</Label>
                                    <Input
                                        id="location"
                                        value={data.location}
                            ...
                            <CardContent className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <Textarea
                                        ...
                                        rows={4}
                                        placeholder="Cac yeu cau doi voi ung vien..."
                                    />
                                    {errors.requirements && (
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Textarea
                                        ...
                                        rows={4}
                                        placeholder="Cac quyen loi cho nhan vien..."
                                    />
                                    {errors.benefits && (
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                <div className="grid gap-4 md:grid-cols-3">
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="deadline">Han nop ho so</Label>
                                        <Input
                                            id="deadline"
                                            type="date"
                                            value={data.deadline}
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                ...
                                                <SelectItem value="closed">Dong</SelectItem>
                                            </SelectContent>
                                        </Select>
                                        {errors.status && (
                                ...
                                <div className="flex justify-end gap-2">
                                    <Button type="button" variant="outline" asChild>
                                        <Link href={route('employer.jobs.index')}>Huy</Link>
                                    </Button>
                                    <Button type="submit" disabled={processing}>
                                        {processing ? 'Đang lưu...' : 'Cập nhật tin tuyển dụng'}
                                    </Button>
                                </div>
                            </CardContent>
                        </Card>
